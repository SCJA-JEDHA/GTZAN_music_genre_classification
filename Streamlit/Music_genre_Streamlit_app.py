...
genres_path = f"{general_path}/Data/genres_original"
...
st.set_page_config(
    page_title="🎧 Audio Explorer music-genre-classification GTZAN dataset jedha dsfs-ft-41",
    page_icon="💸 ",
    layout="wide"
)
...
st.title("🎧 Audio Explorer - GTZAN dataset jedha dsfs-ft-41 🎨")
